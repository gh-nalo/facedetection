...
PATH_EMBEDDINGS = os.path.join(PATH_RECOGNITION, "embeddings.pickle")
PATH_RECOGNIZER = os.path.join(PATH_RECOGNITION, "recognizer.pickle")
PATH_LABELENCODER = os.path.join(PATH_RECOGNITION, "labelencoder.pickle")
PATH_EMBEDDER = os.path.join(PATH_RECOGNITION, "openface.nn4.small2.v1.t7")
